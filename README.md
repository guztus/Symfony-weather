...
3. Rename the ".env.example" file to ".env" and edit the JWT_PASSPHRASE in .env and generate a keypair - `symfony console lexik:jwt:generate-keypair`
4. Set the <a href="https://home.openweathermap.org/api_keys">OpenWeatherMap (free)</a> API key - `symfony console secrets:set OPENWEATHERMAP_API_KEY`
5. Set up the database - `php bin/console doctrine:database:create`
6. Run the migrations - `php bin/console doctrine:migrations:migrate`
7. To run the project, enter `symfony serve`
